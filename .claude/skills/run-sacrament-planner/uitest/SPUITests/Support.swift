...
/// whatever build of SacramentPlanner is currently installed on the booted simulator. That's what
/// keeps the harness outside the app's own Xcode project.
let app = XCUIApplication(bundleIdentifier: "com.ericsims.SacramentPlanner")
