...
/// Reading and writing the `.pulpitplan` interchange format.
///
...
public enum Interchange {
    ...
    public static let fileExtension = "pulpitplan"
    /// Reverse-DNS identifier for the custom `UTType` the app declares.
    public static let typeIdentifier = "com.ericsims.pulpit.plan"
    public static let generator = "Pulpit/1"
    ...
    /// "2026-08-02 Sacrament Meeting.pulpitplan"
